...
export class GetMediaAudioStateCommand implements RealtimeCommandHandler {
  ...
  handle(c: RealtimeCommandContext, e: RealtimeEnvelope) {
    emptySchema.parse(e.payload);
    return this.media.getAudioState(requireMediaSession(c));
  }
}
export class CreateMediaTransportCommand implements RealtimeCommandHandler {
  ...
  constructor(private readonly media: MediaController) {}
  handle(c: RealtimeCommandContext, e: RealtimeEnvelope) {
    return this.media.createTransport(requireMediaSession(c), e.payload);
  }
}
export class ConnectMediaTransportCommand implements RealtimeCommandHandler {
  ...
  constructor(private readonly media: MediaController) {}
  handle(c: RealtimeCommandContext, e: RealtimeEnvelope) {
    return this.media.connectTransport(requireMediaSession(c), e.payload);
  }
}
export class ProduceAudioCommand implements RealtimeCommandHandler {
  ...
  constructor(private readonly media: MediaController) {}
  handle(c: RealtimeCommandContext, e: RealtimeEnvelope) {
    return this.media.produceAudio(requireMediaSession(c), e.payload);
  }
}
export class ListAudioProducersCommand implements RealtimeCommandHandler {
  ...
  handle(c: RealtimeCommandContext, e: RealtimeEnvelope) {
    emptySchema.parse(e.payload);
    return this.media.listAudioProducers(requireMediaSession(c));
  }
}
export class ConsumeAudioCommand implements RealtimeCommandHandler {
  ...
  constructor(private readonly media: MediaController) {}
  handle(c: RealtimeCommandContext, e: RealtimeEnvelope) {
    return this.media.consumeAudio(requireMediaSession(c), e.payload);
  }
}
